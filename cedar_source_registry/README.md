...
| `negative_findings.jsonl` | 433 | Phase 3 formal negatives: tribes checked with no public registry found, with recheck dates |
...
| `nations.jsonl` | 549 | nation crosswalk stub (Phase 0) — see "Nation crosswalk" below |
