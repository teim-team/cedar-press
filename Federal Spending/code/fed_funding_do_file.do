...
replace tribe_id=204 if strpos(Tribe, "oneida tribe of wisconsin")==1
replace tribe_id=204 if strpos(Tribe, "oneida tribe of indians of wis")==1
replace tribe_id=204 if strpos(Tribe, "oneida tribe of indians of wisconsin")==1
replace tribe_id=204 if strpos(Tribe, "oneida tribe of wi")==1
replace tribe_id=204 if strpos(Tribe, "oneida nation")==1 & recipient_state_code=="WI"
replace tribe_id=204 if strpos(Tribe, "oneida nation farms")==1
replace tribe_id=204 if strpos(Tribe, "oneida")==1
replace tribe_id=204 if strpos(Tribe, "oneida tribal school")==1
replace tribe_id=204 if strpos(Tribe, "oneida housing authority")==1
...
replace tribe_id=205 if strpos(Tribe, "oneida nation")==1 & recipient_state_code=="NY"
replace tribe_id=205 if strpos(Tribe, "oneida indian nation")==1
