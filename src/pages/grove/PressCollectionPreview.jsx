// REVIEW OWNER: Havala
//
// A collection's preview, on the door: what it is, how far back it goes,
// and six of its real records.
//
...
// are the whole of what a visitor can reach. So the preview shows six of
...
//
// The door owns which collection is in hand (the twelve tiles); this file
// only draws the one it is given. The action names the way in at Tribal
// Business News for the shelf the collection sits on, never a route past
// the paywall.
...
/** How many of the ten sample records the preview shows. Six fits under
 *  the description without the preview becoming the viewer. */
const STAGE_ROWS = 6;
    ...
    <div className="cp-stage" data-testid="collection-stage" data-collection={entry.id}>
      <div className="cp-stage__head">
        <span className="cp-read__cap">
          Included in <TierName name={tier.name} />
        </span>
