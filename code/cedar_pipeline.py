...
KNOWN_ORDERINGS = [
    ...
    {"rebuild": "23d_build_gaming_facilities.py",
     ...
     "cost": "not yet paid - declared at creation. Any rebuild of the "
             ...
             "and the quoted statute or compact clause behind "
             "`state_revenue_disclosure_status = SEALED_BY_STATUTE_OR_COMPACT` "
             "on 174 rows in seven states - of which 113 are evidenced sealed "
             "(`SEALED_HELD_BY_REGULATOR`), 58 are "
             "`DISPOSITION_UNSUPPORTED_BY_RECORDED_QUOTE` (MN 48, NV 10) and "
             "3 are `NOT_COLLECTED_BY_THIS_BODY` (CO), so 174 is the count of "
             "the ASSERTION and 113 the count of the evidence. "
