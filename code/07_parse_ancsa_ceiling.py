...
def main():
    ...
    ANC_CANONICAL = ["anc_id", "corporation_name", "anc_class", "status", "uei",
                     "cage_code", "parent_entity_class", "confidence_tier",
                     "note", "source", "source_url", "fetched_date"]
    fields = _carry_live_columns(OUT, ANC_CANONICAL)
