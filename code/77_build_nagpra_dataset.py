...
def _derive(canonical, path):
    ...
    after `845` rule 17 flagged `BRIDGE_FIELDS -> nagpra_notice_entity_bridge.csv`
    as losing `cedar_uid`. Same shape as `code/354_correction_register.py`.
    """
