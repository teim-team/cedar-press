...
_terms_path = os.path.join(CLEAN, 'compact_terms.csv')
_tf = _carry_live_columns(_terms_path, TF)
with open(_terms_path, 'w', newline='', encoding='utf-8') as fh:
    w = csv.DictWriter(fh, fieldnames=_tf, extrasaction='ignore', restval='')
    w.writeheader()
