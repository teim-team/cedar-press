...
4. **Obligations are signed.** A deobligation is a negative row, so a county's Native sum can exceed its all-recipient sum with nothing wrong. Only the ROW COUNTS are guaranteed to need.
