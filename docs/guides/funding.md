...
| 13 | `recipient_type` | recipient type | One readable recipient type from the source-code dictionary, after the conflict check. | text | owed: not in the file until the producer builds it |
