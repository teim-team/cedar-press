...
| `need` | `enterprise_existing_cedar_uid` | the enterprise as a register entity in its own right, distinct from its owner | enterprise_id, or a documented cross-reference to the enterprise's own cedar_uid | adjudicate | 1 | 1 |
