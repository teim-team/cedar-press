...
*Generated by `code/23_cross_dataset_propagation.py` on 2026-08-05. Re-run after every ruling batch.*
...
- Identifier-dataset applications: **7,507**
- Rulings reaching more than one dataset: **66**
...
3. **METHOD** - a discredited method taints its output wherever it landed.
   Quarantined: cluster_v3, need_v6, sam_namematch_2026_05_06. 7,971 identifiers affected.
