...
|---|---|---|---|---|
| Native Hawaiian Organization | 4 | 0 | 0 | 65 |
...
| url_type | n | meaning |
|---|---:|---|
| `none_established` | 72 | checked, nothing found at all |
...
| `no_own_site_found` | 9 | checked; something was found but not a site of the entity's own |
...
| `form_990` | 4 | IRS filing record ABOUT the entity; not its website |
| `parked_domain` | 2 |  |
