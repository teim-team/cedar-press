...
2. **Tribal regulatory environment**: compact approvals (merging into COMPACT_DATASET_PLAN.md), liquor ordinances (an underrated commercial-development indicator — ordinance activity clusters around casino/resort/retail buildout), and rules affecting taxation, contracting, housing, energy, health, self-governance — assembled as proceedings.
