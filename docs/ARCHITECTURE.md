...
| Path references to rewrite | 362, across 88 files |
...
First, "did all 362 references get rewritten?" is a question the build, the
...
is one of the three things that answer "did all 362 references get rewritten?",
