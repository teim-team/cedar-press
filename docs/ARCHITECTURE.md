...
| Path references to rewrite | 304, across 72 files |
...
First, "did all 304 references get rewritten?" is a question the build, the
...
is one of the three things that answer "did all 304 references get rewritten?",
