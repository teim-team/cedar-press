...
| Path references to rewrite | 376, across 90 files |
...
First, "did all 376 references get rewritten?" is a question the build, the
...
is one of the three things that answer "did all 376 references get rewritten?",
