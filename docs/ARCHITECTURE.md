...
| | |
|---|---|
| Files to move | 85 — `features/grove` 51, `pages/grove` 32, `components/grove` 1, `styles/grove` 1 |
| Path references to rewrite | 286, across 70 files |
| Referencing files inside `src/` | 31 — `pages/` 25, `features/` 2, `context/` 2, `components/` 1, `main.jsx` 1 |
...
First, "did all 286 references get rewritten?" is a question the build, the
...
is one of the three things that answer "did all 286 references get rewritten?",
