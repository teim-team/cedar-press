...
| | |
|---|---|
| Files to move | 82 — `features/grove` 51, `pages/grove` 29, `components/grove` 1, `styles/grove` 1 |
| Path references to rewrite | 273, across 68 files |
| Referencing files inside `src/` | 29 — `pages/` 23, `features/` 2, `context/` 2, `components/` 1, `main.jsx` 1 |
...
First, "did all 273 references get rewritten?" is a question the build, the
...
is one of the three things that answer "did all 273 references get rewritten?",
