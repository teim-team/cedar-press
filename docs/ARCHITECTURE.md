...
| Path references to rewrite | 349, across 83 files |
...
First, "did all 349 references get rewritten?" is a question the build, the
...
is one of the three things that answer "did all 349 references get rewritten?",
