...
| Path references to rewrite | 360, across 88 files |
...
First, "did all 360 references get rewritten?" is a question the build, the
...
is one of the three things that answer "did all 360 references get rewritten?",
