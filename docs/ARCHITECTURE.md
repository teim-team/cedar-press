...
| Path references to rewrite | 345, across 83 files |
...
First, "did all 345 references get rewritten?" is a question the build, the
...
is one of the three things that answer "did all 345 references get rewritten?",
