...
| Path references to rewrite | 370, across 90 files |
...
First, "did all 370 references get rewritten?" is a question the build, the
...
is one of the three things that answer "did all 370 references get rewritten?",
