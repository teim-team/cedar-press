...
| Path references to rewrite | 372, across 89 files |
...
First, "did all 372 references get rewritten?" is a question the build, the
...
is one of the three things that answer "did all 372 references get rewritten?",
