...
| Path references to rewrite | 285, across 70 files |
...
First, "did all 285 references get rewritten?" is a question the build, the
...
is one of the three things that answer "did all 285 references get rewritten?",
