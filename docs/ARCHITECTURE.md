...
| | |
|---|---|
| Files to move | 84 — `features/grove` 51, `pages/grove` 31, `components/grove` 1, `styles/grove` 1 |
| Path references to rewrite | 280, across 69 files |
| Referencing files inside `src/` | 30 — `pages/` 24, `features/` 2, `context/` 2, `components/` 1, `main.jsx` 1 |
...
First, "did all 280 references get rewritten?" is a question the build, the
...
is one of the three things that answer "did all 280 references get rewritten?",
