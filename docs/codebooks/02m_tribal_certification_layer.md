...
| `whose_ownership` | text | 100% | WHOSE ownership qualifies, and these are DIFFERENT POPULATIONS that do not need: THIS_TRIBE_MEMBER / ANY_FEDERALLY_RECOGNIZED_TRIBE_MEMBER / ANY_NATIVE_PERSON / TRIBAL_GOVERNMENT_ENTITY / SHAREHOLDER_OR_DESCENDANT_OR_SPOUSE / PARENT_CORPORATION / MIXED_SEE_TIERS. A study of individual Native business ownership wants the first three and specifically NOT the sixth. |
