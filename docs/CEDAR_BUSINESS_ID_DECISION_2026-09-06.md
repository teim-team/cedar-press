...
2. **The individually owned entity class closes to new mints.** The 45 `Individually Native-owned business` entities keep their uids and gain business ids with an equivalence row. From here a privately owned Native firm is a `CB-` only, its Native ownership a dated relationship with a certification as its basis, and the publication rule for the class applies to it through the ownership relationship rather than through the entity class. A firm that is genuinely a canonical Native institution is admitted to the entity register by adjudication, under an existing class, never under this one.
