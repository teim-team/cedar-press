...
| **TOTAL** | **2,761,813** | **0** | **0** | **19,339 (union)** | **2,901** |
...
|---|---:|---|
| `parent_uei` | 793 | immediate/direct corporate parent |
...
Self-edges dropped (row-level occurrences): 1,703,588.
Rows where one side of a candidate edge was blank: 4,712,621.
...
- Distinct parents with at least one child: **1,273**
- Parents with **more than one child**: **233**
- Parents with >1 child under `ultimate_parent_uei` alone: **174**
- Distinct children carrying at least one ownership parent: **2,315**
- Children recorded under **more than one** ownership parent: **204**
...
| 2 | `NW2RJN8TQQW1` | GOVERNMENT OF THE UNITED STATES | 66 |
| 3 | `RQ13XQQKKQ67` | AFOGNAK NATIVE CORPORATION | 62 |
| 4 | `CY16XXPHX213` | ARCTIC SLOPE REGIONAL CORPORATION | 49 |
| 5 | `ZHEGXL9HYV43` | CHENEGA CORPORATION | 49 |
| 6 | `PQUEL5MZFDJ3` | BRISTOL BAY NATIVE CORPORATION | 45 |
| 7 | `S2SVA1GNRVK5` | COOK INLET REGION  INC | 34 |
...
| 12 | `TBAHL1WANLF3` | THE CHEROKEE NATION | 23 |
| 13 | `FM96SF3VF8H9` | TYONEK NATIVE CORPORATION | 23 |
| 14 | `L2YMLW7SK3K8` | CHUGACH ALASKA CORPORATION | 23 |
| 15 | `KEBVZNK93W87` | NAVAJO NATION TRIBAL GOVERNMENT, THE | 21 |
| 16 | `M5H7HESFYJL5` | ALEUT CORPORATION  THE | 21 |
| 17 | `P9QQX7RT8E98` | GOLDBELT  INCORPORATED | 21 |
| 18 | `R9JCCCG5ETB6` | OLGOONIK CORPORATION | 20 |
| 19 | `XMKLMV8GCWJ5` | SEALASKA CORPORATION | 19 |
| 20 | `HM1PS6FAK6U7` | AHTNA  INCORPORATED | 18 |

Names shown are the **modal** name recorded for that UEI (the name appearing on the most
transaction rows). 8,813 UEIs were recorded under more than one distinct
...
|---|---|---:|
| `NW2RJN8TQQW1` | GOVERNMENT OF THE UNITED STATES | 66 |
| `GK1ECPGZV897` | GOVERNMENT OF THE UNITED STATES | 1 |
| `R8U7S9K184F6` | GOVERNMENT OF THE UNITED STATES | 1 |
...
|---|---:|---:|
| Nodes (distinct UEIs) | 12,744 | 19,339 |
| Non-self ownership pairs | 1,593 | 2,541 |
| ... of which `parent_uei` | 1,548 | 793 |
| ... of which `ultimate_parent_uei` | 1,548 | 1,891 |

- **NEW ownership pairs found by this rebuild (not in the old graph): 959**
- Ownership pairs in the old graph not reproduced here: 11
- UEIs observed here that are absent from the old graph: 6,595
...
`data/clean/fpds_uei_cage_map.csv` — 29,981 distinct (uei, cage_code,
legal_business_name) triples.

- Triples with a non-empty CAGE code: 7,465
- Distinct UEIs with at least one CAGE code: 6,299 of 19,339 observed UEIs
...
| Path | Rows |
|---|---:|
| `data/clean/fpds_uei_edges.csv` | 2,901 |
| `data/clean/fpds_uei_cage_map.csv` | 29,981 |
