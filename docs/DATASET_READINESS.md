...
|---|---|---:|---|---|---|---:|---|
| `_entity_layer` | **READY** | 42 | 42/42 | 42/42 | clean | 0 | declared |
| `contractors` | **READY** | 10 | 10/10 | 10/10 | clean | 0 | declared |
| `deals` | **READY** | 15 | 15/15 | 15/15 | clean | 0 | declared |
| `federal-register` | **READY** | 23 | 23/23 | 23/23 | clean | 0 | declared |
| `funding` | **READY** | 14 | 14/14 | 13/14 (+1 REFUSED) | clean | 0 | declared |
| `gaming` | **READY** | 56 | 56/56 | 56/56 | clean | 0 | declared |
