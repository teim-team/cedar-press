...
The largest reductions are Native Nonprofits from 67 to 24 columns, Cedar NEED from 65 to 30, and Prime Contracting from 72 to 49. Those starting counts come from the current published sample headers, not the older review bundle.
