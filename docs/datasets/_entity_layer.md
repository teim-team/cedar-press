...
**Status: READY** — 35 customer tables, shelf `infrastructure`, measured 2026-09-02 by `518`.

No open contract point. Next action: **maintain**.

| contract point | state |
|---|---|
| C1 grain stated | 35/35 |
| C2 validated primary key | 35/35 |
...
| `cedar_entity_freshness.csv` *(UNDOCUMENTED)* | 1,555 | — | no dated column |
| `cedar_entity_identity_crosswalk.csv` | 10,107 | — | no dated column |
| `cedar_entity_spine.csv` *(unregistered)* | — | — | **not built** |
| `cedar_identifier_graph_edges.csv` | 46,820 | — | no dated column |
...
| `cedar_ruling_ledger_consolidated.csv` | 43,321 | `ruling_date` | 2026 |
| `cedar_rulings.csv` *(unregistered)* | — | — | **not built** |
| `cross_dataset_ruling_map.csv` | 22,936 | — | no dated column |
...
| `foia_request_index.csv` | 20,102 | — | no dated column |
