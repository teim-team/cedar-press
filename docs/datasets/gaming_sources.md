...
**Status: BLOCKED** — 52 customer tables, shelf `grove`, measured 2026-09-01 by `518`.
...
Next action: **C1 grain UNSTATED on 7: fac_audit_sefa_gaming_programs.csv, nigc_action_parties.csv, nigc_document_surface.csv**.

| contract point | state |
|---|---|
| C1 grain stated | 45/52 |
| C2 validated primary key | 45/52 |
| C3 literal duplicates | clean |
| C4 identity path | 92% keyed |
| C5 row conservation | 1/52 |
...
| `digital_gaming_revenue.csv` | 10,661 | `period_end` | 2021–2026 |
