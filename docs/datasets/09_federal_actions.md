...
*Maintenance doc. Generated 2026-09-04. Tier: **Cedar Press ($500) - Federal Register***
...
**Status: READY** — 23 customer tables, shelf `standard`, measured 2026-09-02 by `518`.

No open contract point. Next action: **maintain**.

| contract point | state |
|---|---|
| C1 grain stated | 23/23 |
| C2 validated primary key | 23/23 |
| C3 literal duplicates | clean |
| C4 identity path | 88% keyed [mixed] |
| C5 row conservation | 22/23 |
...
| `fr_content_classification.csv` | 156,897 | `publication_date` | 1994–2026 |
...
| `section_106_consultation_events.csv` | 1,367 | `notice_date` | 1994–2026 |
...
| File | Rows | Size |
|---|---:|---:|
| `data/clean/federal_actions.csv` | 156,897 | 244 MB |
| `data/clean/federal_actions_raw.csv` | 156,897 | 236 MB |
