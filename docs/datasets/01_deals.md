...
**Status: BLOCKED** — 14 customer tables, shelf `standard`, measured 2026-09-01 by `518`.
...
Next action: **C1 grain UNSTATED on 2: deals_2026_ytd_additions.csv, tribal_resolution_financings.csv**.

| contract point | state |
|---|---|
| C1 grain stated | 12/14 |
| C2 validated primary key | 12/14 |
| C3 literal duplicates | clean |
| C4 identity path | 95% keyed |
| C5 row conservation | 0/14 |
| C6 unresolved conflicts | 0 shipped as definite |
| C7 double counting | 2 tables |
