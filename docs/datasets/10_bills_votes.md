...
**Status: BLOCKED** — 12 customer tables, shelf `standard`, measured 2026-09-01 by `518`.
...
Next action: **C1 grain UNSTATED on 2: congressional_correspondence_log.csv, native_bills_subject_sweep.csv**.

| contract point | state |
|---|---|
| C1 grain stated | 10/12 |
| C2 validated primary key | 10/12 |
| C3 literal duplicates | 5 rows |
| C4 identity path | 100% keyed [indian_country] |
| C5 row conservation | 0/12 |
...
| `congressional_correspondence_log.csv` | 0 | — | no dated column |
...
| `native_bills_subject_sweep.csv` | 2,414 | `introduced_date` | 1993–2026 |
