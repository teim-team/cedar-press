...
*Maintenance doc. Generated 2026-09-04. Tier: **Cedar Press+ ($1,000) - Federal Subcontracting***
...
**Status: READY** — 3 customer tables, shelf `pro`, measured 2026-09-02 by `518`.
...
|---|---|
| C1 grain stated | 3/3 |
| C2 validated primary key | 3/3 |
| C3 literal duplicates | clean |
| C4 identity path | 98% keyed |
...
| File | Rows | Size |
|---|---:|---:|
| `data/clean/subawards.csv` | 89,809 | 110 MB |
