...
**Status: BLOCKED** — 10 customer tables, shelf `standard`, measured 2026-09-01 by `518`.
...
Next action: **C1 grain UNSTATED on 3: faads_transactions.csv, faads_transactions_all_agencies.csv, native_passthrough.csv**.

| contract point | state |
|---|---|
| C1 grain stated | 7/10 |
| C2 validated primary key | 7/10 |
| C3 literal duplicates | 180,374 rows |
| C4 identity path | 40% keyed |
| C5 row conservation | 3/10 |
| C6 unresolved conflicts | 0 shipped as definite |
| C7 double counting | 3 tables |
...
|---|---:|---|---|
| `assistance_tribe_id_crosswalk.csv` *(internal-by-decision)* | 361 | — | no dated column |
...
| `native_passthrough.csv` | 1,262 | `fiscal_year` | 2010–2026 |
| `native_passthrough_pairs.csv` | 212 | — | no dated column |
